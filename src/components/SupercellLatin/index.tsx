...
const SupercellLatin = (incomingProps: SupercellLatinProps) => {
  const { props } = useProps(
    { Lead: true, Extra: false } as SupercellLatinProps,
    incomingProps
  )
  ...
  return (
    <>
      ...
      {render(
        'div',
        {
          'data-figma-id': '4250:52976',
          className:
            'flex min-h-[40px] items-center gap-[16px] w-[100%] h-[100%] absolute top-[0px] left-[0px]',
        },
        props['Lead'] &&
          render(
            'div',
            {
              'data-figma-id': '4250:52915',
              className:
                'flex justify-center items-center flex-shrink-0 w-[40px] h-[auto] relative',
            },
            render(
              'div',
              {
                'data-figma-id': '4250:52916',
                className:
              ...
              render(
                'div',
                {
                  'data-figma-id': 'I4250:52916;37634:15751',
                  className:
                ...
                props['Icon'] ||
                  render(
                    'div',
                    {
                      'data-figma-id': 'I4250:52916;37634:15752',
                      className: 'w-[24px] h-[24px] relative',
                    },
                    render(
                      'div',
                      {
                        'data-figma-id': 'I4250:52916;37634:15752;1:85',
        ...
        render(
          'div',
          {
            'data-figma-id': '4250:52944',
            className: 'flex items-center gap-[16px] flex-1 h-[auto] relative',
          },
          render(
            'div',
            {
              'data-figma-id': 'I4250:52944;4250:49611',
              className:
            ...
            render(
              'div',
              {
                'data-figma-id': 'I4250:52944;4250:52676',
                className: 'flex items-center self-stretch h-[auto] relative',
              },
              render(
                'div',
                {
                  'data-figma-id': 'I4250:52944;4250:56233',
                  className: 'flex items-center flex-1 h-[auto] relative',
                },
                render(
                  'p',
                  {
                    'data-figma-id': 'I4250:52944;4250:56233;4250:53639',
                    className:
            ...
            props['Subtitle'] &&
              render(
                'div',
                {
                  'data-figma-id': 'I4250:52944;4250:52678',
                  className: 'flex items-center self-stretch h-[auto] relative',
                },
                render(
                  'div',
                  {
                    'data-figma-id': 'I4250:52944;4250:56268',
                    className: 'flex items-center flex-1 h-[auto] relative',
                  },
                  render(
                    'p',
                    {
                      'data-figma-id': 'I4250:52944;4250:56268;4250:53650',
                      className:
